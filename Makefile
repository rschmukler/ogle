...
test-coverage:
	NODE_ENV=test OGLE_COVERAGE=1 $(MOCHA_PATH) --require blanket --reporter html-cov > coverage.html

test-coveralls:
	NODE_ENV=test OGLE_COVERAGE=1 $(MOCHA_PATH) --require blanket --reporter mocha-lcov-reporter | ./node_modules/coveralls/bin/coveralls.js
